...
export const DICT = {
  th: {
    ...
    settings_ai_hub_desc:
      "ถ้ามี AI Hub แยกไว้คอยวิเคราะห์ข้อมูลอินเวอร์เตอร์และแจ้งเตือนผ่าน LINE ให้กรอก URL ของ AI Hub นั้นที่นี่ แดชบอร์ดจะดึงผลล่าสุดมาแสดง (ไม่ต้องใช้ key ใดๆ เพราะ AI Hub เก็บ key ไว้ฝั่งเซิร์ฟเวอร์เองแล้ว)",
  ...
  en: {
    ...
    settings_ai_hub_desc:
      "If you have a separate AI Hub analyzing inverter data and sending LINE alerts, enter its URL here. The dashboard will fetch its latest verdict (no key needed — the AI Hub keeps its keys server-side).",
    settings_ai_hub_url_label: "AI Hub URL",
    settings_ai_hub_url_placeholder: "https://your-ai-hub.vercel.app",
